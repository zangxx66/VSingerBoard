...
.glassmorphism {
  ...
  transition: opacity 0.3s, transform 0.3s, z-index 0.2s;
...
.mx-menu-bar.mac,
.mx-context-menu.mac {
  --menu-font-family: Inter, 'Helvetica Neue', Helvetica, 'PingFang SC',
    'Hiragino Sans GB', 'Microsoft YaHei', '微软雅黑', Arial, sans-serif;
...
.mx-context-menu-item-display {
  display: block;
}

.mx-context-menu-item-hide {
  display: none;
}
...
.b-credential-card-header {
    display: block;
    align-items: center;
}

.qcode-image-container {
    position: relative;
    display: block;
}
.qcode {
